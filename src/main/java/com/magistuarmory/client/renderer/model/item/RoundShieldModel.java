...
public class RoundShieldModel extends MedievalShieldModel
{
	...
	public RoundShieldModel() 
	{
		...
		plate.texOffs(0, 33).addBox(-7.5F, -6.0F, -2.0F, 15, 7, 1, 0.0F);
		plate.texOffs(36, 33).addBox(-6.5F, 1.0F, -2.0F, 13, 2, 1, 0.0F);
		plate.texOffs(40, 36).addBox(-5.5F, 3.0F, -2.0F, 11, 1, 1, 0.0F);
		plate.texOffs(48, 38).addBox(-3.5F, 4.0F, -2.0F, 7, 1, 1, 0.0F);
		plate.texOffs(36, 44).addBox(-6.5F, -8.0F, -2.0F, 13, 2, 1, 0.0F);
		plate.texOffs(48, 40).addBox(-3.5F, -10.0F, -2.0F, 7, 1, 1, 0.0F);
		plate.texOffs(40, 42).addBox(-5.5F, -9.0F, -2.0F, 11, 1, 1, 0.0F);
