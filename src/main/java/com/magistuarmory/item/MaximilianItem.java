...
public class MaximilianItem extends ArmorItem
{
    public MaximilianItem(String unlocName, IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties properties)
    {
    ...
    {
        return (KnightlyArmory.PROXY instanceof ClientProxy) ? (A)((ClientProxy)KnightlyArmory.PROXY).getMaximilianModel(armorSlot) : null;
    }
