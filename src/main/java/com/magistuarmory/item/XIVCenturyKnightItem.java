...
public class XIVCenturyKnightItem extends ItemArmor implements IHasModel {
	
	BascinetModel model;
	
	public XIVCenturyKnightItem(String unlocName, ArmorMaterial materialIn, int renderId, EntityEquipmentSlot slot) {
