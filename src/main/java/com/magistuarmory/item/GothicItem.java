...
public class GothicItem extends ItemArmor implements IHasModel {
	
	SalletModel model;
	
	public GothicItem(String unlocName, ArmorMaterial materialIn, int renderId, EntityEquipmentSlot slot) {
