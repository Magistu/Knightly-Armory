...
public class MedievalBowItem extends BowItem implements IHasModelProperty
{
    ...
    public MedievalBowItem(Properties p_40660_, float arrowSpeed, float pullTime)
    {
        super(p_40660_);
		this.projectileSpeed = arrowSpeed;
         ...
         if (!itemstack.isEmpty() || flag) {
            ...
            if (!((double)f < 0.1D)) {
               ...
               if (!p_40668_.isClientSide) {
                  ...
                  abstractarrow.shootFromRotation(player, player.getXRot(), player.getYRot(), 0.0F, f * this.projectileSpeed, 1.0F);
                  if (f == 1.0F) {
