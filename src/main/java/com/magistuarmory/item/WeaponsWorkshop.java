...
public class WeaponsWorkshop
{
    ...
    static
    {
        ...
        ZWEIHANDER = ((material, prop) -> (new MedievalWeaponItem(material.getMaterialName() + "_zweihander", modifyDurability(prop, material, 1.0f), material, 6.5f, 1.0f, getAttackSpeed(1.1f, material, 0.05f), 4, 0.4f)).setTwoHanded(2));
        FlAMEBLADEDSWORD = ((material, prop) -> (new MedievalWeaponItem(material.getMaterialName() + "_flamebladedsword", modifyDurability(prop, material, 1.0f), material, 6.4f, 1.0f, getAttackSpeed(1.1f, material, 0.05f), 4, 0.4f)).setTwoHanded(2).setFlamebladed());
