...
public class WeaponsWorkshop
{
    ...
    static
    {
        ...
        RANSEUR = ((material, prop) -> (new MedievalWeaponItem(material.getMaterialName() + "_ranseur", modifyDurability(prop, material, 1.0f), material, 3.1f, 1.0f, getAttackSpeed(1.07f, material, 0.0f), 0, 1.0f)).setTwoHanded(1).setBlocking(3.0f, 3.0f));
        AHLSPIESS = ((material, prop) -> (new MedievalWeaponItem(material.getMaterialName() + "_ahlspiess", modifyDurability(prop, material, 1.0f), material, 4.0f, 1.0f, getAttackSpeed(1.28f, material, 0.02f), 18, 0.5f)).setTwoHanded(2).setBlocking(6.0f, 3.0f));
        ...
        BASTARDSWORD = ((material, prop) -> (new MedievalWeaponItem(material.getMaterialName() + "_bastardsword", modifyDurability(prop, material, 1.0f), material, 4.25f, 1.0f, getAttackSpeed(1.55f, material, 0.02f))).setTwoHanded(1).setBlocking(6.0f, 5.0f));
        ESTOC = ((material, prop) -> (new MedievalWeaponItem(material.getMaterialName() + "_estoc", modifyDurability(prop, material, 1.0f), material, 4.0f, 1.0f, getAttackSpeed(1.45f, material, 0.0f), 3, 0.2f)).setTwoHanded(1).setBlocking(4.0f, 5.0f));
        ...
        ZWEIHANDER = ((material, prop) -> (new MedievalWeaponItem(material.getMaterialName() + "_zweihander", modifyDurability(prop, material, 1.0f), material, 6.5f, 1.0f, getAttackSpeed(1.1f, material, 0.05f), 4, 0.4f)).setTwoHanded(2).setBlocking(7.0f, 6.0f));
        FlAMEBLADEDSWORD = ((material, prop) -> (new MedievalWeaponItem(material.getMaterialName() + "_flamebladedsword", modifyDurability(prop, material, 1.0f), material, 6.4f, 1.0f, getAttackSpeed(1.1f, material, 0.05f), 4, 0.4f)).setTwoHanded(2).setFlamebladed().setBlocking(7.0f, 6.0f));
        LOCHABERAXE = ((material, prop) -> (new MedievalWeaponItem(material.getMaterialName() + "_lochaberaxe", modifyDurability(prop, material, 1.0f), material, 8.0f, 1.0f, getAttackSpeed(1.0f, material, 0.05f), 0, 0.5f)).setTwoHanded(1).setBlocking(5.0f, 3.0f));
        CONCAVEHALBERD = ((material, prop) -> (new MedievalWeaponItem(material.getMaterialName() + "_concavehalberd", modifyDurability(prop, material, 1.0f), material, 9.5f, 1.0f, getAttackSpeed(0.9f, material, 0.05f), 2, 0.5f)).setTwoHanded(2).setBlocking(10.0f, 3.0f));
        ...
        GUISARME = ((material, prop) -> (new MedievalWeaponItem(material.getMaterialName() + "_guisarme", modifyDurability(prop, material, 1.0f), material, 3.15f, 1.0f, getAttackSpeed(1.02f, material, 0.0f), 0, 0.8f)).setTwoHanded(1).setBlocking(3.0f, 3.0f));
    }
